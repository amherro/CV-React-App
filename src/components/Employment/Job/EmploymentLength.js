...
export default class EmploymentLength extends Component {
    render() {
        const { started, ended, startJobDate, endJobDate } = this.props
        return (
            <div className='employment-length-input-section'>
                ...
                <div className='employment-calendar'>
                    <div className='start-calendar'>
                        ...
                        <input className='calendar' type='date' value={started} onChange={startJobDate}></input>
                    </div>
                    <div className='end-calendar'>
                        <p className='calendar-label'>Ended</p>
                        <input className='calendar' type='date' value={ended} onChange={endJobDate}></input>
                    </div>
                </div>
            </div>
        )
